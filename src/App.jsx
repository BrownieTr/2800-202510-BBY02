...
function App() {
  ...
  return (
    <Routes>
      ...
      <Route path="/favSport" element={<ProtectedRoute><FavSport /></ProtectedRoute>} />
      <Route path="/findingMatch" element={<ProtectedRoute><FindingMatch /></ProtectedRoute>} />
      <Route path="/sportsBetting" element={<ProtectedRoute><SportsBetting /></ProtectedRoute>} />
    </Routes>
  );
}
