  ...
  return (
    <form onSubmit={handleSubmit} className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="flex justify-end gap-4">
        <Button className="text-white bg-blue-600 hover:bg-blue-700"  onClick={onCancel}>Cancel</Button>
        <Button className="text-white bg-blue-600 hover:bg-blue-700" type="submit">Save</Button>
      </div>
    </form>
  );
}
